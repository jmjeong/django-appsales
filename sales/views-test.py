...
appname = (
        'Pagiggg II', 'Numbeeer III', 'AncientPiig', 'Smile Tags',
        'DocToGooos', 'LogMeeln Igniiis', 'Smile Again App',
        'Ancient Combaaat', 'Darks, Candles, Long',
        'StartCraft Story', 'Connect the Rope',
        'Life is Long', 'True Story')
