...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Date.account'
        db.add_column('sales_date', 'account', self.gf('django.db.models.fields.CharField')(default='nemustech@nemustech.co.kr', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Date.account'
        db.delete_column('sales_date', 'account')
